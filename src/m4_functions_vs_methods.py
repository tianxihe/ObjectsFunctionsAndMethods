...
def try_methods():
    koto=rg.SimpleTurtle()
    koto.pen=rg.Pen('brown', 5)
    koto.forward(150)
    koto.left(90)
    koto.forward(50)
    koto.backward(100)
...
def try_methods_and_functions():
    koko=rg.SimpleTurtle()
    koko.pen=rg.Pen('blue', 5)
    koko.backward(150)
    koko.speed=1
    draw_many_squares(koko, 2, 100, 30)
    koko.speed=5
    koko.pen=rg.Pen('red',5)
    draw_many_squares(koko, 10, 50, 15)
    koko.speed=100
    koko.pen=rg.Pen('red',35)
    draw_many_squares(koko, 8, 300, 60)
    koko.pen=rg.Pen('black',3)
    koko.backward(200)
    """
    Constructs a SimpleTurtle and sets its   pen  to a new rg.Pen
